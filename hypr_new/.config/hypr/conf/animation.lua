...
hl.animation({ leaf = "windows",     enabled = true, speed = 5,    bezier = "overshoot", style = "gnomed" })
-- hl.animation({ leaf = "windowsIn", enabled = true, speed = 4.1, bezier = "easeOutQuint", style = "popin 87%" })
hl.animation({ leaf = "windowsOut",  enabled = true, speed = 5,    bezier = "ease",      style = "slide bottom" })
hl.animation({ leaf = "windowsMove", enabled = true, speed = 5,    bezier = "overshoot", style = "slide" })
